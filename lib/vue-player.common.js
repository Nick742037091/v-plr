...
// load the styles
var content = __webpack_require__("b60d");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("033e25c5", content, true, {"sourceMap":false,"shadowMode":false});
...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_controls_vue_vue_type_style_index_0_id_85f46044_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("0883");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_controls_vue_vue_type_style_index_0_id_85f46044_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_controls_vue_vue_type_style_index_0_id_85f46044_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_3_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_4_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_controls_vue_vue_type_style_index_0_id_85f46044_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
module.exports = JSON.parse("{\"name\":\"v-plr\",\"version\":\"0.1.1\",\"main\":\"lib/vue-player.common.js\",\"keyword\":\"vue video audio player\",\"private\":false,\"scripts\":{\"serve\":\"vue-cli-service serve\",\"build\":\"vue-cli-service build --target lib --name vue-player --dest lib --formats commonjs src/index.js\",\"lint\":\"vue-cli-service lint\"},\"dependencies\":{\"core-js\":\"^2.6.5\",\"lodash\":\"^4.17.15\",\"normalize.css\":\"^8.0.1\",\"vue\":\"^2.6.10\"},\"devDependencies\":{\"@vue/cli-plugin-babel\":\"^3.11.0\",\"@vue/cli-plugin-eslint\":\"^3.11.0\",\"@vue/cli-service\":\"^3.11.0\",\"babel-eslint\":\"^10.0.1\",\"epic-spinners\":\"^1.1.0\",\"eslint\":\"^5.16.0\",\"eslint-plugin-vue\":\"^5.0.0\",\"node-sass\":\"^4.12.0\",\"sass-loader\":\"^8.0.0\",\"screenfull\":\"^5.0.0\",\"vconsole\":\"^3.3.4\",\"vue-template-compiler\":\"^2.6.10\"},\"eslintConfig\":{\"root\":true,\"env\":{\"node\":true},\"extends\":[\"plugin:vue/essential\",\"eslint:recommended\"],\"rules\":{\"no-console\":\"off\",\"no-debugger\":\"off\"},\"parserOptions\":{\"parser\":\"babel-eslint\"}},\"postcss\":{\"plugins\":{\"autoprefixer\":{}}},\"browserslist\":[\"> 1%\",\"last 2 versions\"]}");
...
// module
exports.push([module.i, ".video-control-panel[data-v-85f46044]{position:absolute;left:0;right:0;top:0;bottom:0;color:#fff;font-size:12px;overflow:hidden}.video-control-panel .loading[data-v-85f46044]{position:absolute;left:50%;top:50%;-webkit-transform:translate(-50%,-50%);transform:translate(-50%,-50%)}.video-control-panel .bottom-bar[data-v-85f46044]{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-ms-flex-direction:row;flex-direction:row;-webkit-box-align:center;-ms-flex-align:center;align-items:center;background:-webkit-gradient(linear,left top,left bottom,from(rgba(0,0,0,.15)),to(rgba(0,0,0,.4)));background:linear-gradient(180deg,rgba(0,0,0,.15),rgba(0,0,0,.4));position:absolute;left:0;right:0;bottom:0}.video-control-panel .bottom-bar .btn-fullscreen[data-v-85f46044],.video-control-panel .bottom-bar .btn-play[data-v-85f46044]{width:15px;height:15px;padding:10px}.video-control-panel .bottom-bar .time-block[data-v-85f46044]{width:80px}.video-control-panel .bottom-bar .slider[data-v-85f46044]{-webkit-box-flex:1;-ms-flex:1;flex:1;margin:0 5px 0 10px}.video-control-panel .top-bar[data-v-85f46044]{background:-webkit-gradient(linear,left bottom,left top,from(rgba(0,0,0,.1)),to(rgba(0,0,0,.2)));background:linear-gradient(0deg,rgba(0,0,0,.1),rgba(0,0,0,.2));position:absolute;left:0;right:0;top:0;text-align:center;line-height:40px}.video-control-panel .fade-bottom-enter-active[data-v-85f46044],.video-control-panel .fade-bottom-leave-active[data-v-85f46044]{-webkit-transition:all .5s ease-in-out;transition:all .5s ease-in-out}.video-control-panel .fade-bottom-enter[data-v-85f46044],.video-control-panel .fade-bottom-leave-to[data-v-85f46044]{opacity:0;-webkit-transform:translateY(100%);transform:translateY(100%)}.video-control-panel .fade-top-enter-active[data-v-85f46044],.video-control-panel .fade-top-leave-active[data-v-85f46044]{-webkit-transition:all .5s ease-in-out;transition:all .5s ease-in-out}.video-control-panel .fade-top-enter[data-v-85f46044],.video-control-panel .fade-top-leave-to[data-v-85f46044]{opacity:0;-webkit-transform:translateY(-100%);transform:translateY(-100%)}", ""]);
...
// EXTERNAL MODULE: ./packages/video/src/controls.vue?vue&type=style&index=0&id=85f46044&lang=scss&scoped=true&
var controlsvue_type_style_index_0_id_85f46044_lang_scss_scoped_true_ = __webpack_require__("65ce");
...
var controls_component = normalizeComponent(
  ...
  controlsvue_type_template_id_85f46044_scoped_true_render,
  controlsvue_type_template_id_85f46044_scoped_true_staticRenderFns,
  false,
  null,
  "85f46044",
  null
